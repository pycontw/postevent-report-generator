...
@click.option(
    "--interactive/--no-interactive", default=False, show_default=True, help="Quiet mode. Useful for automation. True for no prompt."
)
@click.option("--cjk-support/--no-cjk-support", default=False, show_default=True, help="Enable CJK support in the plot or not.")
