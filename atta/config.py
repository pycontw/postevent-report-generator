...
class Configuration(object):
    ...
    def read_configuration(self, conf_file=None):
        ...
        try:
            ...
            # fallback value
            config['ATTENDEE']['paid_date'] = \
                config_default['ATTENDEE']['paid_date']
        ...
        try:
            ...
            # fallback value
            config['ATTENDEE']['nationality'] = \
                config_default['ATTENDEE']['nationality']
        ...
        try:
            ...
            # fallback value
            config['ATTENDEE']['job_title'] = \
                config_default['ATTENDEE']['job_title']
